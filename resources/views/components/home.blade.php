...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ url('public/home') }}/assets/images/logo/logo2.png">
    <!-- Other css -->
    <link rel="stylesheet" href="{{ url('public/home') }}/assets/css/animate.css">
    <link rel="stylesheet" href="{{ url('public/home') }}/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{ url('public/home') }}/assets/css/icofont.min.css">
    <link rel="stylesheet" href="{{ url('public/home') }}/assets/css/swiper.min.css">
    <link rel="stylesheet" href="{{ url('public/home') }}/assets/css/hc-offcanvas-nav.css">
    <link rel="stylesheet" href="{{ url('public/home') }}/assets/css/style.css">
...
<body>
    ...
    <div class="mobile-menu">
        <div class="container">
            <div class="mobile-menu-wrapper">
                <div class="logo">
                    <a href="index.html">
                        <img src="{{ url('public/home') }}/assets/images/logo/logo.png" alt="Mukti">
                    </a>
                </div>
            ...
            <div class="container">
                <div class="row justify-content-between align-items-center px-15">
                    <div class="header-logo">
                        <a href="index.html" class="logo"><img src="{{ url('public/home') }}/assets/images/logo/logo.png" alt="logo"></a>
                    </div>
                    <ul class="header-contact-info d-flex align-items-center">
                        <li class="item">
                            <div class="item-inner">
                                <div class="item-thumb">
                                    <img src="{{ url('public/home') }}/assets/images/header/1.png" alt="">
                                </div>
                        ...
                        <li class="item">
                            <div class="item-inner">
                                <div class="item-thumb">
                                    <img src="{{ url('public/home') }}/assets/images/header/2.png" alt="">
                                </div>
                                <div class="item-content">
                                    <span>Email :</span>
                                    <p>Mukti@gmail.com</p>
                        ...
                        <li class="item">
                            <div class="item-inner">
                                <div class="item-thumb">
                                    <img src="{{ url('public/home') }}/assets/images/header/3.png" alt="">
                                </div>
                                <div class="item-content">
                                    <span>Address :</span>
                            ...
                            <ul class="nav-widget d-flex justify-content-between align-items-center">
                                ...
                                <li class="buy-cart ml-3">
                                    ...
                                    <div class="cart-content">
                                        <div class="cart-item">
                                            <div class="cart-img">
                                                <a href="#"><img src="{{ url('public/home') }}/assets/images/buycart/1.jpg" alt=""></a>
                                            </div>
                                            <div class="cart-des">
                                        ...
                                        <div class="cart-item">
                                            <div class="cart-img">
                                                <a href="#"><img src="{{ url('public/home') }}/assets/images/buycart/2.jpg" alt=""></a>
                                            </div>
                                            <div class="cart-des">
                                                <a href="#">Product Title Hore</a>
                                                <p>$20.00</p>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="lab-item feature-item wow fadeInLeft" data-wow-delay=".2s"
                                ...
                                <div class="lab-inner">
                                    <div class="lab-thumb">
                                        <img src="{{ url('public/home') }}/assets/images/feature/1.png" alt="feature img">
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="lab-item feature-item wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1s">
                                <div class="lab-inner">
                                    <div class="lab-thumb">
                                        <img src="{{ url('public/home') }}/assets/images/feature/2.png" alt="feature img">
                                    </div>
                                    <div class="lab-content">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="lab-item feature-item wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1s">
                                <div class="lab-inner">
                                    <div class="lab-thumb">
                                        <img src="{{ url('public/home') }}/assets/images/feature/3.png" alt="feature img">
                                    </div>
                                    <div class="lab-content">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <div class="lab-item feature-item wow fadeInRight" data-wow-delay=".2s"
                                ...
                                <div class="lab-inner">
                                    <div class="lab-thumb">
                                        <img src="{{ url('public/home') }}/assets/images/feature/4.png" alt="feature img">
                                    </div>
                                    <div class="lab-content">
                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="row flex-row-reverse align-items-center">
                                            <div class="col-12 col-lg-6">
                                                <div class="post-thumb">
                                                    <img src="{{ url('public/home') }}/assets/images/depart/07.jpg" alt="depart">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="two">
                                        <div class="row flex-row-reverse align-items-center">
                                            <div class="col-12 col-lg-6">
                                                <div class="post-thumb">
                                                    <img src="{{ url('public/home') }}/assets/images/depart/08.jpg" alt="depart">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="post-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="three">
                                        <div class="row flex-row-reverse align-items-center">
                                            <div class="col-12 col-lg-6">
                                                <div class="post-thumb">
                                                    <img src="{{ url('public/home') }}/assets/images/depart/09.jpg" alt="depart">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="post-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="four">
                                        <div class="row flex-row-reverse align-items-center">
                                            <div class="col-12 col-lg-6">
                                                <div class="post-thumb">
                                                    <img src="{{ url('public/home') }}/assets/images/depart/10.jpg" alt="depart">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="post-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="five">
                                        <div class="row flex-row-reverse align-items-center">
                                            <div class="col-12 col-lg-6">
                                                <div class="post-thumb">
                                                    <img src="{{ url('public/home') }}/assets/images/depart/4.jpg" alt="depart">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="post-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="six">
                                        <div class="row flex-row-reverse align-items-center">
                                            <div class="col-12 col-lg-6">
                                                <div class="post-thumb">
                                                    <img src="{{ url('public/home') }}/assets/images/depart/5.jpg" alt="depart">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="post-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="seven">
                                        <div class="row flex-row-reverse align-items-center">
                                            <div class="col-12 col-lg-6">
                                                <div class="post-thumb">
                                                    <img src="{{ url('public/home') }}/assets/images/depart/6.jpg" alt="depart">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="post-content">
        ...
        <div class="container">
            <div class="section-wrapper">
                <div class="counter-item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s">
                    <div class="counter-item-inner">
                        <div class="counter-thumb">
                            <img src="{{ url('public/home') }}/assets/images/counter/01.png" alt="counter">
                        </div>
                ...
                <div class="counter-item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".2s">
                    <div class="counter-item-inner">
                        <div class="counter-thumb">
                            <img src="{{ url('public/home') }}/assets/images/counter/02.png" alt="counter">
                        </div>
                        <div class="counter-content">
                ...
                <div class="counter-item wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">
                    <div class="counter-item-inner">
                        <div class="counter-thumb">
                            <img src="{{ url('public/home') }}/assets/images/counter/03.png" alt="counter">
                        </div>
                        <div class="counter-content">
                ...
                <div class="counter-item wow fadeInRight" data-wow-duration="1s" data-wow-delay=".4s">
                    <div class="counter-item-inner">
                        <div class="counter-thumb">
                            <img src="{{ url('public/home') }}/assets/images/counter/04.png" alt="counter">
                        </div>
                        <div class="counter-content">
        ...
        <div class="container">
            ...
            <div class="section-wrapper">
                <div class="service-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
                    <div class="service-inner">
                        <div class="service-thumb">
                            <img src="{{ url('public/home') }}/assets/images/service/01.jpg" alt="service">
                        </div>
                ...
                <div class="service-item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".2s">
                    <div class="service-inner">
                        <div class="service-thumb">
                            <img src="{{ url('public/home') }}/assets/images/service/02.jpg" alt="service">
                        </div>
                        <div class="service-content">
                ...
                <div class="service-item wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">
                    <div class="service-inner">
                        <div class="service-thumb">
                            <img src="{{ url('public/home') }}/assets/images/service/03.jpg" alt="service">
                        </div>
                        <div class="service-content">
                ...
                <div class="service-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                    <div class="service-inner">
                        <div class="service-thumb">
                            <img src="{{ url('public/home') }}/assets/images/service/04.jpg" alt="service">
                        </div>
                        <div class="service-content">
                ...
                <div class="row justify-content-center">
                        ...
                        <div class="doctor-item style-1 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
                            <div class="doctor-inner">
                                <div class="doctor-thumb">
                                    <img src="{{ url('public/home') }}/assets/images/team/01.jpg" alt="doctor">
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                        <div class="doctor-item style-1 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                            <div class="doctor-inner">
                                <div class="doctor-thumb">
                                    <img src="{{ url('public/home') }}/assets/images/team/02.jpg" alt="doctor">
                                </div>
                                <div class="doctor-content">
                                    <div class="doctor-name">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                        <div class="doctor-item style-1 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                            <div class="doctor-inner">
                                <div class="doctor-thumb">
                                    <img src="{{ url('public/home') }}/assets/images/team/03.jpg" alt="doctor">
                                </div>
                                <div class="doctor-content">
                                    <div class="doctor-name">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                        <div class="doctor-item style-1 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                            <div class="doctor-inner">
                                <div class="doctor-thumb">
                                    <img src="{{ url('public/home') }}/assets/images/team/04.jpg" alt="doctor">
                                </div>
                                <div class="doctor-content">
                                    <div class="doctor-name">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-6 col-xl-4 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
                        <div class="post-item-inner">
                            <div class="post-thumb">
                                <a href="{{ url('public/home') }}/assets/images/blog/1.jpg" data-rel="lightcase:myCollection"><img
                                        src="{{ url('public/home') }}/assets/images/blog/1.jpg" alt="blog post images"></a>
                            </div>
                            <div class="post-content">
                    ...
                    <div class="col-12 col-md-6 col-xl-4 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                        <div class="post-item-inner">
                            <div class="post-thumb">
                                <a href="{{ url('public/home') }}/assets/images/blog/2.jpg" data-rel="lightcase:myCollection"><img
                                        src="{{ url('public/home') }}/assets/images/blog/2.jpg" alt="blog"></a>
                            </div>
                            <div class="post-content">
                                <span class="meta">By <a href="#">Admin</a> March 24, 2021</span>
                                <h4><a href="#">Globa Empoer Extenve Chanels Extensve Creat Method</a></h4>
                    ...
                    <div class="col-12 col-md-6 col-xl-4 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                        <div class="post-item-inner">
                            <div class="post-thumb">
                                <a href="{{ url('public/home') }}/assets/images/blog/3.jpg" data-rel="lightcase:myCollection"><img
                                        src="{{ url('public/home') }}/assets/images/blog/3.jpg" alt="blog"></a>
                            </div>
                            <div class="post-content">
                                <span class="meta">By <a href="#">Admin</a> March 24, 2021</span>
                                <h4><a href="#">Globa Empoer Extenve Chanels Extensve Creat Method</a></h4>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="sponsor-thumb">
                            <img src="{{ url('public/home') }}/assets/images/sponsor/1.png" alt="sponso-img">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="sponsor-thumb">
                            <img src="{{ url('public/home') }}/assets/images/sponsor/2.png" alt="sponso-img">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="sponsor-thumb">
                            <img src="{{ url('public/home') }}/assets/images/sponsor/3.png" alt="sponso-img">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="sponsor-thumb">
                            <img src="{{ url('public/home') }}/assets/images/sponsor/4.png" alt="sponso-img">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="sponsor-thumb">
                            <img src="{{ url('public/home') }}/assets/images/sponsor/5.png" alt="sponso-img">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="sponsor-thumb">
                            <img src="{{ url('public/home') }}/assets/images/sponsor/6.png" alt="sponso-img">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- All Scripts -->
    <script src="{{ url('public/home') }}/assets/js/jquery.js"></script>
    <script src="{{ url('public/home') }}/assets/js/bootstrap.min.js"></script>
    <script src="{{ url('public/home') }}/assets/js/waypoints.min.js"></script>
    <script src="{{ url('public/home') }}/assets/js/swiper.min.js"></script>
    <script src="{{ url('public/home') }}/assets/js/jquery.counterup.min.js"></script>
    <script src="{{ url('public/home') }}/assets/js/wow.min.js"></script>
    <script src="{{ url('public/home') }}/assets/js/circularProgressBar.min.js"></script>
    <script src="{{ url('public/home') }}/assets/js/hc-offcanvas-nav.js"></script>
    <script src="{{ url('public/home') }}/assets/js/functions.js"></script>
</body>
