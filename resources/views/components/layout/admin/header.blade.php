...
<header class="navbar pcoded-header navbar-expand-lg navbar-light headerpos-fixed">
    <div class="m-header">
        ...
        <a href="index.html" class="b-brand">
            <img src="{{ url('public/admin') }}/assets/images/logo.png" style="object-fit: cover; position: static; width: 10%;" class="logo images">
        </a>
    </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-right notification">
                        ...
                        <ul class="noti-body">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius"
                                        src="{{ url('public/admin') }}/assets/images/user/avatar-1.jpg"
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius"
                                        src="{{ url('public/admin') }}/assets/images/user/avatar-2.jpg"
                                        alt="Generic placeholder image">
                                    <div class="media-body">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius"
                                        src="{{ url('public/admin') }}/assets/images/user/avatar-3.jpg"
                                        alt="Generic placeholder image">
                                    <div class="media-body">
            ...
            <li>
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        <div class="pro-head">
                            <img src="{{ url('public/admin') }}/assets/images/user/avatar-1.jpg" class="img-radius"
