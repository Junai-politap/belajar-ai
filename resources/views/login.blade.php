    ...
    <div class="auth-content container">
        <div class="card">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="card-body">
                        <img src="{{ url('public/admin') }}/assets/images/logo-dark.png" alt=""
                ...
                <div class="col-md-6 d-none d-md-block">
                    <img src="{{ url('public/admin') }}/assets/images/auth-bg.jpg" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
...
<div class="footer-fab">
    ...
    <div class="fab-hover">
        <ul class="list-unstyled">
            <li><a href="{{ url('public/admin') }}/doc/index-bc-package.html" target="_blank" data-text="UI Kit"
                    class="btn btn-icon btn-rounded btn-info m-0"><i class="feather icon-layers"></i></a></li>
            <li><a href="{{ url('public/admin') }}/doc/index.html" target="_blank" data-text="Document"
